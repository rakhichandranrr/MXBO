...
abstract class EinarCore_Search {
	private $search_layout;

	public function __construct() {
		add_action( 'wp', array( $this, 'set_variables' ), 11 ); //after einar_core_search_include_layout
	...
	function set_variables() {
		$this->set_search_layout( EinarCore_Headers::get_instance()->get_header_object()->get_search_layout() );
	}
