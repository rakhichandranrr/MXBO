...
class EinarCore_Standard_Header extends EinarCore_Header {
	...
	/**
	 * @return EinarCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return einar_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
