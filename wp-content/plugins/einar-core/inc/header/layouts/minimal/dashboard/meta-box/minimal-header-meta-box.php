...
if ( ! function_exists( 'einar_core_add_minimal_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function einar_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'einar_core_action_after_page_header_meta_map', 'einar_core_add_minimal_header_meta' );
}
