...
if ( ! class_exists( 'EinarCore_Shortcodes' ) ) {
	class EinarCore_Shortcodes {
		...
		function init() {
			...
			include_once EINAR_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once EINAR_CORE_SHORTCODES_PATH . '/class-einarcore-shortcode.php';
			include_once EINAR_CORE_SHORTCODES_PATH . '/class-einarcore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'einar_core_filter_register_shortcodes', array() );
	...
	EinarCore_Shortcodes::get_instance();
}
