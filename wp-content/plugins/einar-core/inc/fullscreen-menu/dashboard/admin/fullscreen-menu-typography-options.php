...
if ( ! function_exists( 'einar_core_fullscreen_menu_typography_options' ) ) {
	/**
	 * Function that add additional header menu layout global options
	 *
	 * @param object $page
	 */
	function einar_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'einar-core' ),
				)
			);
	...
	add_action( 'einar_core_action_after_fullscreen_menu_options_map', 'einar_core_fullscreen_menu_typography_options', 15 );
}
