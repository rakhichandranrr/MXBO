...
if ( ! function_exists( 'einar_core_add_elements_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function einar_core_add_elements_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'elements',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Elements', 'einar-core' ),
				'description' => esc_html__( 'Global Elements Options', 'einar-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$label_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Label Styles', 'einar-core' ),
				)
			);
			...
			$input_fields_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Input Fields Styles', 'einar-core' ),
				)
			);
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Focus Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Focus Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Focus Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Width', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Radius', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Padding', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Styles', 'einar-core' ),
				)
			);
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Hover Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Hover Color', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Box Shadow', 'einar-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_simple_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Textual Styles', 'einar-core' ),
				)
			);
			...
			$slider_arrow_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Slider Arrow Styles', 'einar-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Left Icon SVG Path', 'einar-core' ),
					'description' => esc_html__( 'Enter your sliders arrow left icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'einar-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Right Icon SVG Path', 'einar-core' ),
					'description' => esc_html__( 'Enter your sliders arrow right icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'einar-core' ),
				)
			);
			...
			$slider_arrow_row = $slider_arrow_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Icon Styles', 'einar-core' ),
				)
			);
			...
			do_action( 'einar_core_action_after_elements_options_map', $page );
		}
	}

	add_action( 'einar_core_action_default_options_init', 'einar_core_add_elements_options' );
}
