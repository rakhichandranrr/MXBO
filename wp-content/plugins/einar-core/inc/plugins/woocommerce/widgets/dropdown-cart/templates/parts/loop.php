			...
			<li class="qodef-woo-mini-cart-item qodef-e">
				...
				echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					...
					sprintf(
						...
						esc_attr__( 'Remove this item', 'einar-core' ),
						esc_attr( $product_id ),
						esc_attr( $cart_item_key ),
						esc_attr( $_product->get_sku() ),
						einar_core_get_svg_icon( 'close' )
					),
					$cart_item_key
				);
				?>
				...
				<div class="qodef-e-content">
					...
					<p class="qodef-e-quantity"><?php echo sprintf( esc_html__( 'Quantity: %s', 'einar-core' ), esc_attr( $cart_item['quantity'] ) ); ?></p>
				</div>
			</li>
			<?php
		}
