...
if ( ! function_exists( 'einar_core_add_link_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function einar_core_add_link_typography_options( $page ) {
		...
		if ( $page ) {
			$link_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-link',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Link Typography', 'einar-core' ),
					'description' => esc_html__( 'Set values for link', 'einar-core' ),
				)
			);
	...
	add_action( 'einar_core_action_after_typography_options_map', 'einar_core_add_link_typography_options' );
}
