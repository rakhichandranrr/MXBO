...
if ( ! class_exists( 'EinarCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class EinarCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'einar_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return EinarCore_Dashboard_Rest_API
		 */
	...
	EinarCore_Dashboard_Rest_API::get_instance();
}
