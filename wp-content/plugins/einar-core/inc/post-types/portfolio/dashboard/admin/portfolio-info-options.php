...
if ( ! function_exists( 'einar_core_add_portfolio_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function einar_core_add_portfolio_info_typography_options( $page ) {
		...
		if ( $page ) {
			$portfolio_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Portfolio Info', 'einar-core' ),
					'description' => esc_html__( 'Set typography values for portfolio info elements', 'einar-core' ),
				)
			);
			...
			$portfolio_info_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Styles', 'einar-core' ),
				)
			);
			...
			$portfolio_info_typography_row->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Top Margin - Big Layouts', 'einar-core' ),
					'description' => esc_html__( 'Set top margin size for portfolio item big layouts on portfolio single page', 'einar-core' ),
					'args'        => array(
						'col_width' => 6,
					),
				)
			...
			$portfolio_info_typography_row->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Top Margin - Small Layouts', 'einar-core' ),
					'description' => esc_html__( 'Set top margin size for portfolio item small layouts on portfolio single page', 'einar-core' ),
					'args'        => array(
						'col_width' => 6,
					),
				)
			...
			$portfolio_info_link_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Link Styles', 'einar-core' ),
				)
			);
	...
	add_action( 'einar_core_action_after_portfolio_options_map', 'einar_core_add_portfolio_info_typography_options' );
}
