<?php if ( $query_result->have_posts() ) {
	while ( $query_result->have_posts() ) :
		...
		if ( ! empty( $layout ) && 'slider' === $layout ) {
			einar_core_list_sc_template_part( 'post-types/portfolio/shortcodes/portfolio-interactive-showcase', 'layouts/' . $layout . '-images', '', $params );
		}
