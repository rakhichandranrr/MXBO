...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image qodef--background" <?php qode_framework_inline_style( $style ); ?>>
		<?php echo einar_core_get_list_shortcode_item_image( $image_dimension, $portfolio_list_image ); ?>
		<?php if ( isset($glass_effect) && 'yes' === $glass_effect ) { ?>
			<?php einar_core_render_svg_icon( 'glass-filter' ) ?>
		<?php } ?>
	</div>
<?php } ?>
