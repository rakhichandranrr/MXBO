...
if ( ! function_exists( 'einar_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function einar_core_add_side_area_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'einar_core_action_after_mobile_header_options_map', 'einar_core_add_side_area_mobile_header_options', 10, 2 );
}
