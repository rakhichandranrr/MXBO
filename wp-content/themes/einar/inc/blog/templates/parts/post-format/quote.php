...
if ( ! empty( $quote_text ) ) {
	...
	<div class="qodef-e-quote">
		<<?php echo einar_escape_title_tag( $title_tag ); ?> class="qodef-e-quote-text"><?php echo esc_html( $quote_text ); ?></<?php echo einar_escape_title_tag( $title_tag ); ?>>
		<?php if ( ! empty( $quote_author ) ) { ?>
			<<?php echo einar_escape_title_tag( $author_title_tag ); ?> class="qodef-e-quote-author"><?php echo esc_html( $quote_author ); ?></<?php echo einar_escape_title_tag( $author_title_tag ); ?>>
		<?php } ?>
		<?php if ( ! is_single() ) { ?>
